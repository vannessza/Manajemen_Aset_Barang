        ...
        <div class="mx-4">
            <div class="flex justify-between">
                <div class="flex">
                    ...
                    <h1 class="lg:text-lg font-semibold text-gray-900 ml-4">Detail Penghancuran</h1>
                </div>
            </div>
            ...
            <div class="">
                ...
                <div class="mt-2 flex">
                    ...
                    {{-- <div class="mt-2 flex">
                        <p class="w-60">Formulir Penghancuran</p>
                        <a href="{{ route('pengembalian.show.exportformulir', $penghancuran->id) }}" class="bg-[#008d8d] hover:bg-[#006c6c] text-white font-bold py-1 px-2 rounded text-sm">
