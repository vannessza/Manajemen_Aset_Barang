...
<div class="container mt-36 mb-10">
    <div class="bg-white rounded-xl shadow-xl max-w-2xl py-5 px-8 m-auto">
        ...
        <div class="mx-auto block max-w-xl rounded-lg bg-white p-6 shadow-4">
            <form action="{{ route('user.show.daftaraset.pengembalian.store', ['user_id' => $user->id, 'peminjaman_id' => $peminjaman->id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <a href="{{ route('user.show.daftaraset.pengembalian.exportformulir', ['user_id' => $user->id, 'peminjaman_id' => $peminjaman->id]) }}" class="bg-[#008d8d] hover:bg-[#006c6c] text-white font-bold py-1 px-2 rounded text-sm">
                            Download Formulir
                        </a>
                    </div>
                    <div class="sm:col-span-2">
