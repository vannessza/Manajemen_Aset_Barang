                          ...
                          <td class="whitespace-nowrap">
                            ...
                            <td class="whitespace-nowrap">
                                <div class="px-6 py-1.5">
                                     <a class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline font-medium" href="{{ route('user.show.daftaraset.showhistory', ['user_id' => $user->id, 'peminjaman_id' => $pe->id]) }}">
                                        Detail
                                    </a>
                                    <a class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline font-medium" href="{{ route('user.show.daftaraset.pengembalian', ['user_id' => $user->id, 'peminjaman_id' => $pe->id]) }}">
                                        Pengembalian
                                    </a>
                                </div>
                            </td>
