        ...
        <div class="md:flex justify-between items-center">
          ...
          <div class="mt-4 md:mt-0">
                <div class="inline-flex gap-x-2">
                  <a class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-[#00C74F] text-white hover:bg-green-700 disabled:opacity-50 disabled:pointer-events-none" href="{{ route('aset.index') }}">
              ...
              <div class="p-1.5 min-w-full inline-block align-middle">
                <div class="border rounded-lg divide-y divide-gray-200">
                  <div class="relative max-w-xs ml-2 mb-4">
                    <form method="GET" action="{{ route('profile.daftaraset') }}">
                          ...
                          <td class="whitespace-nowrap">
                            ...
                            <td class="whitespace-nowrap">
                                <div class="px-6 py-1.5">
                                     <a class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline font-medium" href="{{ route('profile.daftaraset.show', $pe->id) }}">
                                        Detail
                                    </a>
                                    <a class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline font-medium" href="{{ route('profile.daftaraset.pengembalian', $pe->id) }}">
                                        Pengembalian
                                    </a>
                                </div>
                            </td>
