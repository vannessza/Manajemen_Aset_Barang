                ...
                <a href="">
                    <div class="bg-white w-full lg:w-96 h-[176px] rounded-xl shadow-xl max-w-md mx-auto">
                        <div class="flex justify-between">
                            ...
                            <div class="">
                                <h1 class="py-3 px-4 text-[20px] bg-[#ECD391] text-[#FFA800] mr-8 mt-5">0</h1>
                            </div>
                        </div>
                ...
                <a href="">
                    <div class="bg-white w-full lg:w-96  h-[176px] rounded-xl shadow-xl max-w-md mx-auto">
                        <div class="flex justify-between">
                            ...
                            <div class="">
                                <h1 class="py-3 px-4 text-[20px] bg-[#A4F4E6] text-[#00FFF0] mr-8 mt-5">0</h1>
                            </div>
                        </div>
                ...
                <a href="">
                    <div class="bg-white w-full lg:w-96  h-[176px] rounded-xl shadow-xl max-w-md mx-auto">
                        <div class="flex justify-between">
                            ...
                            <div class="">
                                <h1 class="py-3 px-4 text-[20px] bg-[#F9BABA] text-[#FF0F00] mr-8 mt-5">0</h1>
                            </div>
                        </div>
                ...
                <a href="">
                    <div class="bg-white w-full lg:w-96 h-[176px] rounded-xl shadow-xl max-w-md mx-auto">
                        <div class="flex justify-between">
                            ...
                            <div class="">
                                <h1 class="py-3 px-4 text-[20px] bg-[#A9FF65] text-[#24B400] mr-8 mt-5">0</h1>
                            </div>
                        </div>
                ...
                <a href="">
                    <div class="bg-white w-full lg:w-96 h-[176px] rounded-xl shadow-xl max-w-md mx-auto">
                        <div class="flex justify-between">
                            ...
                            <div class="">
                                <h1 class="py-3 px-4 text-[20px] bg-[#969696] text-[#2C2C2C] mr-8 mt-5">0</h1>
                            </div>
                        </div>
