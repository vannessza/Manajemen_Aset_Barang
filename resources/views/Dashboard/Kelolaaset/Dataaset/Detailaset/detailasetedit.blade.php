                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="date" id="tanggal" name="tanggal" 
                               ...
                               value="{{ old('tanggal', $asetDetail->tglPembelian) }}" 
                               required>
                        @error('tanggal')
                            <p class="text-red-500 text-xs mt-2">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="sm:col-span-2 flex items-center my-auto">
                        <div class="w-1/3 flex mr-4">
                            <img class="img-preview inline-block h-40 w-40 rounded-full object-cover object-center" src="{{ $asetDetail->image ? asset('storage/'. $asetDetail->image) : '' }}">
                        </div>                        
                        <div class="max-w-sm">
                            <label class="block">
                                <input type="hidden" name="oldImage" value="{{ $asetDetail->image }}">
                                @error('image')
                                    <p class="text-red-500 text-xs mt-2">{{ $message }}</p>
                                @enderror
