            ...
            <form action="{{ route('detailaset.store', $aset->id ) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="namaAset" id="namaAset" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder="Masukkan nama aset register" required>
                    </div>
                    <div class="sm:col-span-2">
                    ...
                    <div class="" data-hs-input-number="">
                        ...
                        <div class="w-full flex justify-between items-center gap-x-5">
                            <div class="grow">
                                <input id="masaRetensi" name="masaRetensi" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" type="text" required>
                            </div>
                    ...
                    <div class="" data-hs-input-number="">
                        ...
                        <div class="w-full flex justify-between items-center gap-x-5">
                            <div class="grow">
                                <input id="jumlah" name="jumlah" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" type="text" required>
                            </div>
                            <div class="flex justify-end items-center gap-x-1.5">
