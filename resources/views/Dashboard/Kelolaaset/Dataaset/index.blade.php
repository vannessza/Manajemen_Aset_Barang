    ...
    <div class="bg-white w-auto rounded-xl shadow-xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        <div class="flex justify-between items-center">
          <div>
            ...
            <a href="{{ route('dataaset.create') }}" class="bg-[#00C74F] text-white py-2 px-4 rounded-md shadow-xl">Tambah</a>
        </div>
        @if(count($dataAset) > 0)
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                      <thead class="bg-gray-50">
                        <tr>
                          ...
                          <th scope="col" class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">Kode Aset</th>
                      ...
                      <tbody class="divide-y divide-gray-200">
                        ...
                        <tr>
                          ...
                          <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800">{{ $da['kodeAset'] }}</td>
                          <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800">{{ $da['namaAset'] }}</td>
                          <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800">{{ $da['jenisAset'] }}</td>
                          <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800">{{ $da['klasifikasiAset'] }}</td>
